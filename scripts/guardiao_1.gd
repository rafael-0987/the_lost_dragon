...
var descontar_lua: int = 20
var pagou: bool = false

var dialog_data: Dictionary = {
	0: {
		"title": "guardião",
		"face": "res://sprite/guardiao/face_vermmelho.png",
		"dialog": "tras 20 luas para mim!!! ai eu deixo você passar. OBS: aperte" + " 'l' " + "para dar a lua "
	}
}
